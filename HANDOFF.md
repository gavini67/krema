...
- [ ] **Phase 0 — owner setup. BLOCKS Phases 3–4. Only CAPTCHA left.**
  ...
  - [ ] **CAPTCHA** — hCaptcha or Turnstile keys, then Auth → Attack Protection. **Not done. This is the only remaining blocker.**
  - [ ] Optional: confirm min password length 6 + "No required characters"; export customers CSV before Phase 3 alters the schema.
