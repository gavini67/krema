...
- [ ] **Phase 0 — owner activation. The code is prepared; production setup and end-to-end testing are still pending.**
  ...
  - [ ] Before activation, export the customers CSV; paste `docs/migrations/2026-09-13-customer-accounts.sql` in the Supabase SQL Editor; deploy the CAPTCHA-capable pages; configure Supabase CAPTCHA with the private Secret Key; then enable public email signup.
