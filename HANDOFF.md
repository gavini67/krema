...
- [x] **Phase 0 — owner activation. Production setup is complete; customer account activation was verified end to end on 2026-09-13.**
  ...
  - [x] **Public email signup enabled** after CAPTCHA was confirmed live. Confirm email remains enabled.
  ...
  - [ ] Operational follow-up: while logged in as staff, verify a customer login in another tab does not end the staff session, then test staff unlink once. The separate storage keys already ship in Phase 2; this is the remaining live staff-side check.
...
- [x] **Phase 3 — customer accounts. LIVE and verified 2026-09-13.** SQL, page deployment, Turnstile, public signup, OTP claim, login, and PIN recovery all passed on production. Migration: `docs/migrations/2026-09-13-customer-accounts.sql`.
...
- [ ] **Phase 4 — newsletter.** Phase 0 is complete; this is the next build. Wire the currently dead footer form to a protected subscriber table, then use Brevo for campaigns and unsubscribe handling.
